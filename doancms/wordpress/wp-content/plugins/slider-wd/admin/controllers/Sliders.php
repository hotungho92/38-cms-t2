...
class SlidersController_wds {
   ...
   */
	public function save_slider_db( $id = 0) {
		...
		$del_slide_ids_string = ( isset($params_array['del_slide_ids_string']) ? rtrim($params_array['del_slide_ids_string'], ',') : '');
   ...
   */
	public function save_slide_db( $id = 0 ) {
		...
		foreach ($slides as $slide) {
		  ...
		  if ( $slide_id ) {
			$del_layer_ids_string = ( (isset($params_array['slide' . $slide_id . '_del_layer_ids_string']) && !$save_as_copy ) ? rtrim(sanitize_text_field($params_array['slide' . $slide_id . '_del_layer_ids_string']), ',') : '');
